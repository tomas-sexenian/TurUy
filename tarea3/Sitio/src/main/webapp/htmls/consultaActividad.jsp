...
<div class="container-fluid page-header">
	<div class="container">
		<div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
			<h3 class="display-4 text-white text-uppercase">Consulta de Actividad</h3>
			<div class="d-inline-flex text-white">
				<p class="m-0 text-uppercase"><a class="text-white" href="home">Home</a></p>
				<i class="fa fa-angle-double-right pt-1 px-3"></i>
				<p class="m-0 text-uppercase"><a class="text-white" href="actividades">Actividades</a></p>
				<i class="fa fa-angle-double-right pt-1 px-3"></i>
...
<c:set var="finalizada" value="${sessionScope.finalizada}" scope="session"  />
			...
			<div class="row">
				<div class="col-lg-6" style="min-height: 500px;">
					<div class="position-relative h-100">
						...
						<img class="position-absolute w-100 h-100" src="Imagenes?id=${img}"  style="object-fit: cover;">
					</div>
				</div>
				<div class="col-lg-6 pt-5 pb-lg-5">
					<div class="about-text bg-white p-4 p-lg-5 my-lg-5">
						<h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Actividad</h6>
						<h1 class="mb-3">${sessionScope.actividad.nombre}</h1>	
						<div class="p-4">
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2" style="font-size: large"></i>${sessionScope.actividad.nombreDepartamento}, ${sessionScope.actividad.ciudad}</div>
							</div>
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-hourglass text-primary mr-2" style="font-size: large"></i>${sessionScope.actividad.duracion} horas</div>
							</div>
							
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-calendar-alt text-primary mr-2" style="font-size: large"></i>Fecha alta: ${sessionScope.actividad.fechaAlta} </div>
							</div>
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-calendar-alt text-primary mr-2" style="font-size: large"></i>Fecha baja: ${sessionScope.actividad.fechaBaja} </div>
							</div>
							
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-info-circle text-primary mr-2"></i>${sessionScope.actividad.estado}</div>
							</div>
											...
											<div class="package-item bg-white mb-2">
												...
												<div class="p-4">
													...
													<div class="text-center justify-content-between mb-3 pt-3">
														<a class="h5 text-decoration-none">${salida.nombre}</a>
													</div>
				...
				<div class="col-lg-6 pt-5 pb-lg-5">
					<div class="about-text bg-white p-4 p-lg-5 my-lg-5">
						...
						<div class="p-4">
							...
							<div class="d-flex justify-content-between pb-2">
								<div class="m-0" id = "favs_act"><i class="fa fa-regular fa-star text-primary mr-2" style="font-size: large"></i>${sessionScope.actividad.cantFavoritos} usuarios marcaron la actividad como favorita</div>
							</div>
							<div class="d-flex justify-content-between pb-2">
								<h5 class="m-0">Costo de la actividad: $${sessionScope.actividad.costo}</h5>
							</div>
								...
								<c:if test="${tipo eq 'Turista'}" >
									<div class="m-0">
										...
										<div class="star-container">
  											<span class="star <c:if test="${sessionScope.esFavorita}" >starred</c:if>">
  												<c:if test="${sessionScope.esFavorita}" >
    												<span class="star-icon fa fa-star starred">
    													<span class = "starred"></span>
    												</span>
    											</c:if>
    											<c:if test="${not sessionScope.esFavorita}" >
    												<span class="star-icon fa fa-star unstarred">
    													<span class = "unstarred"></span>
    												</span>
    											</c:if>
  											</span>
										</div>

    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Modificar datos de proveedor</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Modificar datos de proveedor</p>
                </div>
            </div>
        </div>
    </div>
...
<!--                         <form id="alta" method="post" action="altaUsuario" enctype="multipart/form-data"> -->
                            <form id="modificar" method="post" action="modificarUsuario" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" >
                                    ...
                                    <input type="text" class="form-control px-4" id="link" name="link" style="height: 47px" value="${requestScope.link}" data-target="#link" required="required"  />
                                </div>

                                <!--Descripcion-->
                                <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" >
                                    <label for="ldescripcion">Descripción:</label>
                                    <textarea id="descripcion" name="descripcion" class="form-control px-4" rows="4" cols="50">${requestScope.descripcion}</textarea>
                                </div>

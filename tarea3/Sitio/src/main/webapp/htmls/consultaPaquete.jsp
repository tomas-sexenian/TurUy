						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 mb-4">
								<div class="package-item bg-white mb-2">
									<c:set var = "imgAct" scope="session" value="${act.imageSrc}" />
									
									<c:if test="${empty imgAct }">
										<c:set var = "imgAct" scope="session" value="${initParam.defaultImgAct}" />
									</c:if>
									<img class="img-fluid" src="Imagenes?id=${imgAct}" alt="" style="height: 180px; margin: 5%; width: 90%; object-fit: cover;">
									<div class="p-4">
										<div class="d-flex justify-content-between mb-3">

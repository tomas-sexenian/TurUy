    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="Imagenes?id=carousel-1.jpg" alt="Image" >
            ...
            <div class="carousel-item">
                <img class="w-100" src="Imagenes?id=/carousel-2.jpg" alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-md-3">Viajes y Turismo</h4>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3  ">
            ...
            <div class="col-lg-12 col-md-12 mb-4">
                <div class="package-item bg-white mb-2  pt-1">
                    ...
                    <div class="p-4">
                    	...
                    	<div class="d-flex justify-content-between mb-3">
                            ...
                            <small class="m-0"><i class="fa fa-regular fa-star text-primary mr-2"></i>${act.cantFavoritos} favoritos</small>
                   		</div>
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="text-center pb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <img class="img-fluid" src="Imagenes?id=${img}" alt="" style="height: 230px; object-fit: cover;">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="text-center pb-4">
                    <div class="team-item bg-white mb-4">
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <img class="img-fluid w-100" src="Imagenes?id=${img}" alt="" style="height: 230px; object-fit: cover;">

                        ...
                        <div class="row;text-align:center;">
                            <form id="alta" method="post" action="altaUsuario" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" >
                                    ...
                                    <input type="password" class="form-control px-2" id="contraseña" name="contraseña" style="height: 47px" onchange="validarPass()"  required="required" />
                                </div>

                                <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" >
                                    <label for="confcontraseña">Confirme la contraseña:</label>
                                    <input type="password" class="form-control px-2" id="confcontraseña" name="confcontraseña" style="height: 47px" onchange="validarPass()" required="required" />
                                </div>
                                ...
                                <script>
    								...
    								const myFile = new File([''], '${imgAltaUsuario }', {
        								type: 'text/plain',
                                ...
                                <!--DescripciÃ³n-->
	                                ...
	                                <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" id="contdesc" style=<c:if test="${tipoIngresado eq 'proveedor'}">'display: block'</c:if><c:if test="${tipoIngresado eq 'turista' || empty tipoIngresado}">'display: none'</c:if>>
	                                    ...
	                                    <textarea id="descripcion" name="descripcion" class="form-control px-4" rows="4" cols="50" <c:if test="${tipoIngresado eq 'proveedor'}">required</c:if>><c:if test="${not empty error}">${descripcionIngresado}</c:if></textarea>
	                                </div>
	                                 ...
	                                 <div class="mb-3 mb-md-0 p-lg-4 p-md-2 p-sm-1" id="contlink" style=<c:if test="${tipoIngresado eq 'proveedor'}">'display: block'</c:if><c:if test="${tipoIngresado eq 'turista' || empty tipoIngresado}">'display: none'</c:if>>
	                                    ...
	                                    <input type="text" class="form-control px-2" id="link" name="link" min="0" style="height: 47px" placeholder="" data-target="link" <c:if test="${not empty error }"> value="${linkIngresado }"</c:if>/>
	                                </div>

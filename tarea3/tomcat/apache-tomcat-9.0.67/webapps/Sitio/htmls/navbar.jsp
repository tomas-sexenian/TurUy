...
<div class="container-fluid bg-light pt-3 d-none d-lg-block">
    <div class="container">
        <div class="row" >
            ...
            <form action="search" id ="buscador">
                <div class="d-inline-flex align-items-center" style="padding-bottom: 10px;">
                    <input type="text" class="form-control" id="search" name="search" placeholder="&#xF002; Actividades, Paquetes" style="font-family:Poppins, FontAwesome" />

		...
		if (nombre.isEmpty() || descripcion.isEmpty() || validez.isEmpty() || descuento.isEmpty() || alta == null) {
			...
			try {
				...
				try {
					...
					if (desc < 0) {
						JOptionPane.showMessageDialog(this, "El descuento debe ser positivo",
								"Crear Paquete de actividades", JOptionPane.ERROR_MESSAGE);
						textFieldDescuento.setText("");
					} else if (val < 0) {
						JOptionPane.showMessageDialog(this, "La validez debe ser positiva",
								"Crear Paquete de actividades", JOptionPane.ERROR_MESSAGE);
						...
						// controlSal.CrearSalida(nombre, cant, fechaAlta, salida, fechaSalida,
						// hora,act);
						JOptionPane.showMessageDialog(this, "Se ha registrado correctamente el paquete",
								"Crear Paquete de Actividades", JOptionPane.INFORMATION_MESSAGE);
					...
					JOptionPane.showMessageDialog(this, "El descuento debe ser un numero real",
							"Crear Paquete Actividades", JOptionPane.ERROR_MESSAGE);
					textFieldDescuento.setText("");
				}
			} catch (NumberFormatException e) {
				JOptionPane.showMessageDialog(this, "El periodo de validez debe ser un numero entero",
						"rear Paquete Actividades", JOptionPane.ERROR_MESSAGE);
				textFieldValidez.setText("");
			} catch (EntidadRepetidaException ex) {
				JOptionPane.showMessageDialog(this, ex.getMessage(), "Crear Paquete Actividades",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}

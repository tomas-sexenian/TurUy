	...
	public static void cargarDatos() {
		...
		try {
			...
			controlACT.crearActividad("Colonia", "Visita lugares exclusivos y relevantes", "Colonia Premium Tour", 4,
					...
					new ArrayList<String>(Arrays.asList("Cultura y Patrimonio")), "284kr973");
			...
			controlACT.crearActividad("Rivera",
					...
					new ArrayList<String>(Arrays.asList("Cultura y Patrimonio")), "y4vbc4xc");
			...
			controlACT.aceptarActividad("Cabalgata en el Valle del Lunarejo");
		...
		try {
			...
			controlSAL.crearSalida("Cabalgata 1", 4, LocalDate.of(2022, 8, 15), "Posada del Lunarejo",
					LocalDate.of(2022, 9, 10), "16:00", "Cabalgata en el Valle del Lunarejo", "2p9he77w");
			controlSAL.crearSalida("Cabalgata 2", 4, LocalDate.of(2022, 8, 15), "Posada del Lunarejo",
					LocalDate.of(2022, 9, 11), "16:00", "Cabalgata en el Valle del Lunarejo");
			...
			controlSAL.crearSalida("Cabalgata Extrema", 4, LocalDate.of(2022, 9, 15), "Posada del Lunarejo",
					LocalDate.of(2022, 10, 30), "16:00", "Cabalgata en el Valle del Lunarejo", "3vwzthcr");
		...
		try {
			...
			controlSAL.inscribirTuristaSalidaPaquete("lachiqui", "Almuerzo 1", "Un dia en Colonia", 5,
			...
			controlSAL.inscribirTuristaSalidaPaquete("waston", "Almuerzo 2 ", "Un dia en Colonia", 1,
			...
			controlSAL.inscribirTuristaSalidaPaquete("elelvis", "Almuerzo en el Real 1", "Un dia en Colonia", 2,
					LocalDate.of(2022, 10, 2));
			controlSAL.inscribirTuristaSalidaPaquete("mastropiero", "Tour Colonia del Sacramento 30-10",
					"Un dia en Colonia", 4, LocalDate.of(2022, 10, 5));
			controlSAL.inscribirTuristaSalidaPaquete("mastropiero", "Almuerzo en el Real 1", "Un dia en Colonia", 4,

					...
					<div class="about-text bg-white p-4 p-lg-5 my-lg-5">
						...
						<div class="p-4">
							...
							<div class="d-flex justify-content-between" style="padding-bottom: 20px; padding-top: 20px">
								<div class="m-0"><i class="fa fa-usd" style="font-size: large" aria-hidden="true"></i>Precio del paquete por persona: ${sessionScope.costo}</div>
							</div>
							
							<div class="d-flex justify-content-between" style="padding-bottom: 20px; padding-top: 20px">
								<div class="m-0"><i class="fa fa-newspaper-o" style="font-size: large" aria-hidden="true"></i> ${sessionScope.paquete.descripcion}</div>
							</div>

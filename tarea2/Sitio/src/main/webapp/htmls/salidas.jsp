    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Salidas Turisticas</h3>
        ...
        <div class="container pb-5">
            <div class="bg-light shadow" style="padding: 30px;">
                <div class="row align-items-center" style="min-height: 60px;">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-primary btn-block" onclick="location.href = 'salidas'" style="height: 47px; margin-top: -2px;">Limpiar</button>
                    </div>
            ...
            <c:forEach items="${sessionScope.salidas}" var="sal" varStatus="loop">
            	...
            	<div class="col-lg-4 col-md-4 mb-4">
                	<div class="package-item bg-white mb-2">
                    	...
                    	<img class="img-fluid" src="${initParam.filedir}/${img}" alt="" style="height: 230px; width: 90%; margin: 5%; object-fit: cover;">
                    	<div class="p-4">

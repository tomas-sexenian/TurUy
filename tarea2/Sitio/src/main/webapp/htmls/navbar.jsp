    ...
    <div class="row" >
        <div class="col-lg-12 col-md-12 col-sm-12 text-right py-1">
            <div class=" d-inline-flex " data-toggle="dropdown">
                ...
                <img class="profile-img" src="${initParam.filedir}/${img}">
                <div class="dropdown-menu border-0 m-0 text-right">
                    <a class="dropdown-item" href="consultaUsuario?usuario=${sessionScope.usuario_logueado}">Mi perfil</a>
    ...
    <div class="container">
        <div class="row" >
            ...
            <div class="col-lg-6 text-center text-lg-right mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="padding-bottom: 10px;">
                    <input type="text" class="form-control"  placeholder="&#xF002; Actividades, Paquetes" style="font-family:Poppins, FontAwesome" />
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5" >
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <!-- si es proveedor mostramos esta pestana -->
                    
                    <c:set var = "tipo" scope="session" value="${sessionScope.tipo_usuario}" />

                    <c:set var = "datos" scope="request" value="${applicationScope.datosCargados}" />
					<c:if test="${empty datos}" >
						<a href="cargarDatos" class="nav-item nav-link">Cargar Datos</a>
					</c:if>
					
					
					<c:if test="${tipo == 'Proveedor'}" >
                    
                    <div class="nav-item dropdown" id="proveedores" >
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Proveedores</a>
                        <div class="dropdown-menu border-0 rounded-0 m-0">
                            <a href="altaActividad" class="dropdown-item">Alta de Actividad Turistica</a>
                            <a href="altaSalida" class="dropdown-item">Alta de Salida Turistica</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-0 rounded-0 m-0">
                        	<c:forEach items="${applicationScope.categorias}" var="cat" varStatus="loop">
                            	<a href="actividades?categoria=${cat}" class="dropdown-item">${cat}</a>
                            </c:forEach>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-0 rounded-0 m-0">
						<!-- Sólo mostrar si no está logueado -->
                        	<c:if test="${empty user}" >
                            	<a href="altaUsuario" class="dropdown-item">Alta de Usuario</a>
                            </c:if>
                            <a href="consultaUsuario" class="dropdown-item">Consultar Usuarios</a>
                        </div>
                    </div>
                </div>
            </div>

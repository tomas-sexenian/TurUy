			...
			<div class="row">
				...
				<c:set var = "imgU" scope="session" value="${requestScope.turista.imgSrc}" />
					...
					<div class="position-relative h-100">
						<img class="position-absolute w-100 h-100" src="${UPLOAD_DIRECTORY}/${imgU}" style="object-fit: cover;" alt="">
					</div>
				</div>
									...
									<c:forEach items="${requestScope.inscripciones}" var="insc" varStatus="loop">
										...
										<div class="col-lg-6 col-md-6 mb-4">
											<div class="package-item bg-white mb-2">
												...
												<img class="img-fluid" src="${UPLOAD_DIRECTORY}/${imgA}" alt="" style="height: 180px; width: 90%; margin: 5%; object-fit: cover;">
												<div class="p-4">
													<div class="d-flex justify-content-between mb-3">
...
<!-- 														<small class="m-0"><i class="fa fa-question text-primary mr-2"></i>General</small> -->
						...
						<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
							...
							<c:forEach items="${requestScope.compras}" var="compra" varStatus="loop">
								...
								<div class="col-lg-6 col-md-6 mb-4">
									...
									<div class="package-item bg-white mb-2">
										<img class="img-fluid" src="${UPLOAD_DIRECTORY}/${imgA}" alt="" style="height: 180px; margin: 5%; width: 90%; object-fit: cover;">
										<div class="px-4 py-2">
											<div class="d-flex justify-content-between mb-3">

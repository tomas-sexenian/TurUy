					...
					<div class="about-text bg-white p-4 p-lg-5 my-lg-5">
						...
						<div class="p-4">
							<div class="d-flex justify-content-between mb-3">
								<div class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2" style="font-size: large"></i>${sessionScope.actividad.departamento}, ${sessionScope.actividad.ciudad}</div>
							</div>
							<div class="d-flex justify-content-between mb-3">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 mb-4">
											<div class="package-item bg-white mb-2">
												...
												<img class="img-fluid" src="${initParam.filedir}/${imgSal}" alt="" style="height: 180px; width: 90%; margin: 5%; object-fit: cover;">
												<div class="p-4">
													<div class="d-flex justify-content-between mb-3">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-4">
									...
									<div class="package-item bg-white mb-2">
										...
										<img class="img-fluid" src="${initParam.filedir}/${imgPaq}" alt="" style="height: 180px; margin: 5%; width: 90%; object-fit: cover;">
										<div class="px-4 py-2">
											<div class="d-flex justify-content-between mb-3">

...
public class ConsultarSalidas extends JInternalFrame {
	...
	protected boolean desdeConsultarUsuario = false;
			...
			public void actionPerformed(ActionEvent event) {
				if (comboBoxSalidas.getSelectedItem() != null && comboBoxSalidas.getSelectedItem() != " ") {
					...
					try {
						...
						textFieldHoraSalida.setText(Integer.toString(dataSal.getHoraSalida()));
	...
	public void fromOtraVentana(DataSalidaTuristica salida) {
		...
		textFieldHoraSalida.setText(Integer.toString(salida.getHoraSalida()));
	}
